...
show_help() {
    ...
    echo "  4. App Store apps via mas"
    echo "  5. Shell config symlinks (.zshrc, aliases, exports)"
    echo "  6. Git config + global gitignore"
    echo "  7. Claude skills"
    echo "  8. macOS defaults"
    echo "  9. Node via nvm"
    echo " 10. Directory structure (~/Developer/...)"
    echo " 11. Environment file check"
    echo ""
